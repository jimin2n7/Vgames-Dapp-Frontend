export const nftVgamesABI = [
  {
    inputs: [
      ...
      {
        components: [
          { internalType: 'string', name: 'dstChainName', type: 'string' },
          ...
          { internalType: 'string', name: 'tokensURI', type: 'string' },
          { internalType: 'bool', name: 'isZeroIndexed', type: 'bool' },
          { internalType: 'uint256', name: 'gas', type: 'uint256' },
          { internalType: 'uint256', name: 'redirectFee', type: 'uint256' },
        ],
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: false, internalType: 'address', name: 'collAddr', type: 'address' },
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: 'uint256', name: 'maxPerAddressPublic', type: 'uint256' },
      { internalType: 'uint256', name: 'publicFrom', type: 'uint256' },
      { internalType: 'uint256', name: 'price', type: 'uint256' },
  ...
  { inputs: [], name: 'claimToTreasury', outputs: [], stateMutability: 'nonpayable', type: 'function' },
  {
    inputs: [],
    name: 'collectionName',
    outputs: [{ internalType: 'string', name: '', type: 'string' }],
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'string', name: '_nextTokenURI', type: 'string' },
      { internalType: 'uint256', name: '_mintLimit', type: 'uint256' },
    ],
    name: 'setNextTokenURI',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  },
  ...
  {
    inputs: [{ internalType: 'bool', name: '_isEnabled', type: 'bool' }],
